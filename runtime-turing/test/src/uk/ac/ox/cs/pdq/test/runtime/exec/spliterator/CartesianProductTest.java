...
public class CartesianProductTest {
	...
	/*
	 *  The following are integration tests: CartesianProduct plans are constructed & executed. 
	 */
	...
	public void integrationTestSql3() {
		...
		AccessMethod am2Nation = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N, inputAttributes, 
				relationNation, TPCHelper.attrMap_nation, TPCHelper.getProperties());
		...
		/*
		 * Plan: 
		 * Access on the NATION relation with input on the N_REGIONKEY attribute 
	...
	public void stressTestInMemory1() {
		...
		/*
		 *  The following stress test was inspired by the tests outlined in see issue #209 
		 *  which highlighted a bug in the CartesianProduct implementation at 19/02/2018, 
		 *  the fix of which is tested below.
		 *  
		...
		InMemoryAccessMethod am2Free = new InMemoryAccessMethod(relationR2Attributes, new Integer[0], relationR2, attributeMapping2);
		InMemoryAccessMethod am3Free = new InMemoryAccessMethod(relationR3Attributes, new Integer[0], relationR3, attributeMapping3);
		InMemoryAccessMethod am4Free = new InMemoryAccessMethod(relationR4Attributes, new Integer[0], relationR4, attributeMapping4);
