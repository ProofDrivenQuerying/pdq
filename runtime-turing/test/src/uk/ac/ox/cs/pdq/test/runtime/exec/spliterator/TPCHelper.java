...
public class TPCHelper {
	...
	public static AbstractAccessMethod  amFreeRegion = new DatabaseAccessMethod("REGION", TPCHelper.attrs_R, 
			new Integer[0], relationRegion, TPCHelper.attrMap_region, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0Region = new DatabaseAccessMethod("REGION", TPCHelper.attrs_R, 
	...
	public static AbstractAccessMethod  amFreeRegion_less = new DatabaseAccessMethod("REGION", TPCHelper.attrs_R_LESS, 
			new Integer[0], relationRegion_less, TPCHelper.attrMap_region_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0Region_less = new DatabaseAccessMethod("REGION", TPCHelper.attrs_R_LESS, 
	...
	public static AbstractAccessMethod  amFreeNation = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N, 
			new Integer[0], relationNation, TPCHelper.attrMap_nation, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0Nation = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N, 
	...
	public static AbstractAccessMethod  am2Nation = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N, 
	...
	public static AbstractAccessMethod amFreeNation_less = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N_LESS, 
			new Integer[0], relationNation_less, TPCHelper.attrMap_nation_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0Nation_less = new DatabaseAccessMethod("NATION", TPCHelper.attrs_N_LESS, 
	...
	public static AbstractAccessMethod  amFreeSupplier = new DatabaseAccessMethod("SUPPLIER", TPCHelper.attrs_S, 
			new Integer[0], relationSupplier, TPCHelper.attrMap_supplier, TPCHelper.getProperties());
	public static AbstractAccessMethod  am3Supplier = new DatabaseAccessMethod("SUPPLIER", TPCHelper.attrs_S, 
	...
	public static AbstractAccessMethod  amFreeSupplier_less = new DatabaseAccessMethod("SUPPLIER", TPCHelper.attrs_S_LESS, 
			new Integer[0], relationSupplier_less, TPCHelper.attrMap_supplier_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am3Supplier_less = new DatabaseAccessMethod("SUPPLIER", TPCHelper.attrs_S_LESS, 
	...
	public static AbstractAccessMethod  amFreeCustomer = new DatabaseAccessMethod("CUSTOMER", TPCHelper.attrs_C, 
			new Integer[0], relationCustomer, TPCHelper.attrMap_customer, TPCHelper.getProperties());
	public static AbstractAccessMethod  am03Customer = new DatabaseAccessMethod("CUSTOMER", TPCHelper.attrs_C, 
	...
	public static AbstractAccessMethod  am3Customer = new DatabaseAccessMethod("CUSTOMER", TPCHelper.attrs_C, 
	...
	public static AbstractAccessMethod  amFreeCustomer_less = new DatabaseAccessMethod("CUSTOMER", TPCHelper.attrs_C_LESS, 
			new Integer[0], relationCustomer_less, TPCHelper.attrMap_customer_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am3Customer_less = new DatabaseAccessMethod("CUSTOMER", TPCHelper.attrs_C_LESS, 
	...
	public static AbstractAccessMethod  amFreePart = new DatabaseAccessMethod("PART", TPCHelper.attrs_P, 
	...
	public static AbstractAccessMethod  amFreePart_less = new DatabaseAccessMethod("PART", TPCHelper.attrs_P_LESS, 
	...
	public static AbstractAccessMethod  amFreePartSupp = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS, 
			new Integer[0], relationPartSupp, TPCHelper.attrMap_partSupp, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0PartSupp = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS, 
	...
	public static AbstractAccessMethod  am1PartSupp = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS, 
			Sets.newHashSet(Attribute.create(Integer.class, "PS_SUPPKEY")), 
			relationPartSupp, TPCHelper.attrMap_partSupp, TPCHelper.getProperties());
	public static AbstractAccessMethod  am01PartSupp = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS, 
	...
	public static AbstractAccessMethod  amFreePartSupp_less = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS_LESS, 
			new Integer[0], relationPartSupp_less, TPCHelper.attrMap_partSupp_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am0PartSupp_less = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS_LESS, 
			Sets.newHashSet(Attribute.create(Integer.class, "PS_PARTKEY")), 
			relationPartSupp_less, TPCHelper.attrMap_partSupp_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am1PartSupp_less = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS_LESS, 
			Sets.newHashSet(Attribute.create(Integer.class, "PS_SUPPKEY")), 
			relationPartSupp_less, TPCHelper.attrMap_partSupp_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am01PartSupp_less = new DatabaseAccessMethod("PARTSUPP", TPCHelper.attrs_PS_LESS, 
			Sets.newHashSet(Attribute.create(Integer.class, "PS_PARTKEY"), Attribute.create(Integer.class, "PS_SUPPKEY")), 
			relationPartSupp_less, TPCHelper.attrMap_partSupp_less, TPCHelper.getProperties());
	...
	public static AbstractAccessMethod  amFreeOrders = new DatabaseAccessMethod("ORDERS", TPCHelper.attrs_O, 
			new Integer[0], relationOrders, TPCHelper.attrMap_orders, TPCHelper.getProperties());
	public static AbstractAccessMethod  am1Orders = new DatabaseAccessMethod("ORDERS", TPCHelper.attrs_O, 
	...
	public static AbstractAccessMethod  amFreeOrders_less = new DatabaseAccessMethod("ORDERS", TPCHelper.attrs_O_LESS, 
			new Integer[0], relationOrders_less, TPCHelper.attrMap_orders_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am1Orders_less = new DatabaseAccessMethod("ORDERS", TPCHelper.attrs_O_LESS, 
	...
	public static AbstractAccessMethod  amFreeLineItem = new DatabaseAccessMethod("LINEITEM", TPCHelper.attrs_L, 
			new Integer[0],	relationLineItem, TPCHelper.attrMap_lineItem, TPCHelper.getProperties());
	public static AbstractAccessMethod  am012LineItem = new DatabaseAccessMethod("LINEITEM", TPCHelper.attrs_L, 
	...
	public static AbstractAccessMethod  amFreeLineItem_less = new DatabaseAccessMethod("LINEITEM", TPCHelper.attrs_L_LESS, 
			new Integer[0],	relationLineItem_less, TPCHelper.attrMap_lineItem_less, TPCHelper.getProperties());
	public static AbstractAccessMethod  am012LineItem_less = new DatabaseAccessMethod("LINEITEM", TPCHelper.attrs_L_LESS, 
			Sets.newHashSet(Attribute.create(Integer.class, "L_ORDERKEY"), 
					Attribute.create(Integer.class, "L_PARTKEY"), Attribute.create(Integer.class, "L_SUPPKEY")), 
