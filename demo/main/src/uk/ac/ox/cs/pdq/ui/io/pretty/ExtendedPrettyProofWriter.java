 ...
 */
public class ExtendedPrettyProofWriter /* MR extends PrettyWriter<Proof> */ implements Writer<Proof> {
...
// MR			PrettyFormulaWriter<Formula> dw = PrettyFormulaWriter.to(out).indented();
...
/* MR						if (!q.getPredicate().equals(AccessibleRelation.getInstance())) {
							todo.add(q);
						}*/
					}
				}
