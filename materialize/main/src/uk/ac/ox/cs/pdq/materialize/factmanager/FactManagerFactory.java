 ...
 */
public class FactManagerFactory {

	/** Logger. */
	private static Logger log = Logger.getLogger(FactManagerFactory.class);
	 ...
	 */
	public synchronized FactManager getInstance(
			Schema schema, 
	...
	public synchronized FactManager getInstance(
		...
		try {
			if (type != null) {
				...
				case DATABASE:
					...
					result = new FactDatabaseManager(
		...
		try {
			result = new FactDatabaseManager("org.apache.derby.jdbc.EmbeddedDriver",
