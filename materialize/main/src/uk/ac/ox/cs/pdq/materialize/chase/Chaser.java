...
public abstract class Chaser {
	 ...
	 */
	public abstract boolean entails(ConjunctiveQuery source, ConjunctiveQuery target, Collection<? extends Dependency<?,?>> constraints, HomomorphismDetector detector, FactManager manager);
