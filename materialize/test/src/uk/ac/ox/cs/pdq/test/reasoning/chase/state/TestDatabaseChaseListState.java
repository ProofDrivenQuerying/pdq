...
public class TestDatabaseChaseListState {
	...
	protected DatabaseDiskState state;
	@Mock 
	...
	public void test_chaseStep() {
		...
		this.state = new DatabaseDiskState(this.manager, this.detector);
		this.manager.addFactsSynchronously(Sets.<Atom>newHashSet(f0, f1, f2, f3, f4));
