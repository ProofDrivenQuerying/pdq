...
/**
 * JsonRunner runs a plan and returns a JsonRunResult for simple JSON visualization.
 *
 * @author Camilo Ortiz
 */
public class JsonRunner {
     ...
     * @return
     */
    public static long runtime(Schema schema, ConjunctiveQuery cq, File properties, File planFile){
