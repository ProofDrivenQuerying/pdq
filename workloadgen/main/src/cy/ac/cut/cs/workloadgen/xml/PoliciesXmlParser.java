...
import cy.ac.cut.cs.workloadgen.policies.querygen.IQueryFilterPolicy;
import cy.ac.cut.cs.workloadgen.policies.querygen.IQueryJoinPolicy;
import cy.ac.cut.cs.workloadgen.policies.querygen.IQueryProjectPolicy;
import cy.ac.cut.cs.workloadgen.policies.querygen.QueryGenPolicy;
import cy.ac.cut.cs.workloadgen.policies.viewgen.IViewFilterPolicy;
import cy.ac.cut.cs.workloadgen.policies.viewgen.IViewJoinPolicy;
import cy.ac.cut.cs.workloadgen.policies.viewgen.IViewProjectPolicy;
