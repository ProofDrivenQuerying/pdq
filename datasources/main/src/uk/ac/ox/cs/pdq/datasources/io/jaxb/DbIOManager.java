...
public class DbIOManager extends IOManager {
	...
	public static ExecutableAccessMethod importAccess(File xmlFile) throws JAXBException {
		...
		try {
			...
			//t.printStackTrace();
			// the xml was not a SqlAccessMethod or a InMemoryAccessMethod or an simple web service so assume it is a RESTAccessMethod, one of the older specification formats
