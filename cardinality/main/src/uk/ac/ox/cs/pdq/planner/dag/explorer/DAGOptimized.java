...
import uk.ac.ox.cs.pdq.planner.dag.explorer.parallel.ExplorationThreadResults;
...
public class DAGOptimized extends DAGExplorer {
	...
	protected void _explore() throws PlannerException, LimitReachedException {
		...
		if (this.depth == 1) {
			...
			for(DAGAnnotatedPlan o:this.left) {
				log.trace(o + " " + o.getSize() + " " + o.getCardinality() + " " +  o.getQuality() + " " + o.getAdjustedQuality());
			}
			...
			for(DAGAnnotatedPlan o:output) {
				log.trace(o + "\t\t" +  "Size: " + o.getSize() + "\t" + "Cardinality: " + o.getCardinality() + "\t" +  
