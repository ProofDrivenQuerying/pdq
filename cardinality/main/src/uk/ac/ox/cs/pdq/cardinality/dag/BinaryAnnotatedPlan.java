...
public class BinaryAnnotatedPlan extends DAGAnnotatedPlan {
	...
	public DAGAnnotatedPlan clone() {
		...
		clone.setSizeOf(this.getSizeOf());
		clone.setSizeOfProjection(this.getSizeOfProjection());
		clone.setSize(this.getSize());
		clone.setQuality(this.getQuality());
		clone.setAdjustedQuality(this.getAdjustedQuality());
		clone.setIndependenceAssumptions(this.getIndependenceAssumptions());
		clone.setCoverage(this.getCoverage());
		return clone;
	}
