...
//		for (UnaryAnnotatedPlan leftApplyRule:leftApplyRules) {
//			for (UnaryAnnotatedPlan rightApplyRule:rightApplyRules) {
		...
		for (DAGConfiguration l:left.getSubconfigurations()) {
			for (DAGConfiguration r:right.getSubconfigurations()) {
				if (l.equals(r)
						...
						|| factDominance.isDominated((AnnotatedPlan)l, (AnnotatedPlan)r)
						|| factDominance.isDominated((AnnotatedPlan)r, (AnnotatedPlan)l)
						) {
					return false;
				}
			}
