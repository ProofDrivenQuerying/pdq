...
public class NestedLoopJoinTest {
	...
	public void testNestedLoopJoin() {
		...
		Join target = new NestedLoopJoin(new Access(relation1, amFree), new Access(relation2, amFree));
	...
	public void test1() {
		...
		// target.reset();
		target = new NestedLoopJoin(new Access(relation1, amFree), new Access(relation2, amFree));
	...
	public void test2() {
		 ...
		 * This is the so called equijoin. We use the nested loop join algorithm.
		 */
		Join target = new NestedLoopJoin(new Access(relation2, amFree), new Access(relation3, amFree));
	...
	public void test3() {
		...
		Join target = new NestedLoopJoin(new Access(postgresqlRelationCustomer, amFree), 
	...
	public void test4() {
		...
		Join target = new NestedLoopJoin(new Access(postgresqlRelationSupplier, amFree), selection);
	...
	public void test5() {
		...
		Join target = new NestedLoopJoin(selection, new Access(postgresqlRelationSupplier, amFree));
