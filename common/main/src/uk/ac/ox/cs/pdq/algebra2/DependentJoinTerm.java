...
public class DependentJoinTerm extends RelationalTerm {
	...
	public DependentJoinTerm(Predicate predicate, RelationalTerm child1, RelationalTerm child2) {
	...
	public boolean equals(Object o) {
		...
		return super.equals(o)
				...
				&& this.predicate.equals(((DependentJoinTerm) o).predicate)
				&& this.children.equals(((DependentJoinTerm) o).children);
	}
