...
public class ForeignKey implements Cloneable {
	...
	/**
	 * Returns the number of references - because a single ForeignKey object does not represent a single foreign key. It represents all of them in a specific table.
	 *
	...
	/**
	 * Returns the foreign key references.
