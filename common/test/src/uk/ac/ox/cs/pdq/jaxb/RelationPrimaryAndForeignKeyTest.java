...
public class RelationPrimaryAndForeignKeyTest {
	...
	public void testReadingSchema() {
		try {
			...
			Schema s = IOManager.importSchema(new File("test" + File.separator + "src" + File.separator + "uk" + File.separator + "ac" + File.separator + "ox" + File.separator + "cs" + File.separator + "pdq"  + File.separator + "io" + File.separator + "jaxb" + File.separator + "schemaWithKeys.xml"));
	...
	public void testWritingSchema() {
		try {
			...
			File out = new File("test" + File.separator + "src" + File.separator + "uk" + File.separator + "ac" + File.separator + "ox" + File.separator + "cs" + File.separator + "pdq"  + File.separator + "io" + File.separator + "jaxb" + File.separator + "schemaWithKeys.xml");
	...
	public void ImportExportTest() {
		try {
			...
			File in = new File("test" + File.separator + "src" + File.separator + "uk" + File.separator + "ac" + File.separator + "ox" + File.separator + "cs" + File.separator + "pdq"  + File.separator + "io" + File.separator + "jaxb" + File.separator + "schemaWithKeys.xml");
			File out = new File("test" + File.separator + "src" + File.separator + "uk" + File.separator + "ac" + File.separator + "ox" + File.separator + "cs" + File.separator + "pdq"  + File.separator + "io" + File.separator + "jaxb" + File.separator + "schemaWithKeys2.xml");
