 ...
 * parallel
 * 
 * Most of what is new here over dagoptimized has to do with threading
 * It makes calls to some of the methods for updating best plans that are in dagoptimized
 * 
 * @author Gabor
 *
 */
