...
public class Representative {
	...
	public DAGChaseConfiguration getRepresentative(DAGChaseConfiguration left, DAGChaseConfiguration right) {
		//The equivalence class of the left input configuration
		DAGEquivalenceClass rep0 = left.getEquivalenceClass();
		//The equivalence class of the left input configuration
		DAGEquivalenceClass rep1 = right.getEquivalenceClass();
	...
	public void put(DAGChaseConfiguration left, DAGChaseConfiguration right, DAGChaseConfiguration representative) {
		this.representatives.put(Pair.of(left.getEquivalenceClass(), right.getEquivalenceClass()), representative);
	}
}
