...
public class MapFiringGraph implements FiringGraph{
	 ...
	 * @see uk.ac.ox.cs.pdq.planner.util.FiringGraph#put(Constraint, Atom, Atom, boolean)
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.planner.util.FiringGraph#clone()
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.planner.util.FiringGraph#getGraph()
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.planner.util.FiringGraph#getFactProvenance(Atom)
	 */
	@Override
	 ...
	 * @return FiringGraph
	 * @see uk.ac.ox.cs.pdq.planner.util.chase.FiringGraph#merge(FiringGraph)
	 */
	@Override
