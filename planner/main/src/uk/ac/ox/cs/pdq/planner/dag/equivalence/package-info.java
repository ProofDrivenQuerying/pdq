...
/**
	...
	The definition of fact-equivalent configurations is given below:
	...
	and can work in multi-threaded environments, 
	where different threads are adding/removing configurations belonging to the same class.   
