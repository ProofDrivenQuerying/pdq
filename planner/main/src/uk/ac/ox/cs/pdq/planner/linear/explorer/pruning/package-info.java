 ...
 * removing redundant exposed candidate facts inside a node (facts that are not necessary to find a query match). Redundant exposed candidates lead to redundant joins when translating a linear proof to a plan.
