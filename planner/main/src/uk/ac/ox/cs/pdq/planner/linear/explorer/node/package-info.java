...
/**
	...
	Simple nodes are used when costing plans using a simple cost functions.
	These nodes keep a single path to success.
	
	Blackbox nodes are used when costing plans using a blackbox cost functions.
	These nodes keep every path to success.
