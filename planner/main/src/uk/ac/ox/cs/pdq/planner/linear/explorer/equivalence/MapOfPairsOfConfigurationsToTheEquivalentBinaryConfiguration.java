...
public class MapOfPairsOfConfigurationsToTheEquivalentBinaryConfiguration {
	...
	/** The representatives. */
	private final Map<Pair<List<ChaseConfiguration>,List<ChaseConfiguration>>,DAGChaseConfiguration> representatives  = new ConcurrentHashMap<>();
	 ...
	 */
	public DAGChaseConfiguration getRepresentative(LinearEquivalenceClasses equivalenceClasses, DAGChaseConfiguration left, DAGChaseConfiguration right) {
		...
		//The equivalence class of the left input configuration
		List<ChaseConfiguration> rep1 = equivalenceClasses.getEquivalenceClass(right);
	 ...
	 */
	public void put(LinearEquivalenceClasses eclasses, DAGChaseConfiguration left, DAGChaseConfiguration right, DAGChaseConfiguration representative) {
