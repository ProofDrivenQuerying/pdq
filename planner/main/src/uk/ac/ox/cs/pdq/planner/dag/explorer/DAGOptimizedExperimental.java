 ...
 *
 */
public class DAGOptimizedExperimental extends DAGExplorer {
	 ...
	 * @throws SQLException
	 */
	public DAGOptimizedExperimental(EventBus eventBus, PlannerParameters parameters, ConjunctiveQuery query,
