...
public class MapFiringGraph implements FiringGraph{
	 ...
	 * @param initialState boolean
	 * @see uk.ac.ox.cs.pdq.reasoning.chase.FiringGraph#put(Constraint, Predicate, Predicate, boolean)
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.reasoning.chase.FiringGraph#clone()
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.reasoning.chase.FiringGraph#getGraph()
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.reasoning.chase.FiringGraph#getFactProvenance(Predicate)
	 */
	@Override
	 ...
	 * @return FiringGraph
	 * @see uk.ac.ox.cs.pdq.chase.FiringGraph#merge(FiringGraph)
	 */
	@Override
	 ...
	 * @see uk.ac.ox.cs.pdq.reasoning.chase.FiringGraph#getFactProvenance()
	 */
	@Override
