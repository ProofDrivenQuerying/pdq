...
/**
 * Tests the getMatches method of the MainMemoryHomomorphismManager class 
 * @author Rachel Eaton
 *
 */
public class TestMainMemoryHomomorphismManager {	
	...
	public void setup() throws SQLException {
		...
		this.manager = new MainMemoryHomomorphismManager( schema );
