...
public class TestDatabaseChaseListState {
	...
	public void test_chaseStep() {
		...
		Atom f2 = Atom.create(Predicate.create("R2",2), 
				new Term[]{UntypedConstant.create("c"),UntypedConstant.create("k")});
		
		Atom f3 = Atom.create(Predicate.create("R2",2), 
				new Term[]{UntypedConstant.create("c3"),TypedConstant.create(new String("John"))});
		
		Atom f4 = Atom.create(Predicate.create("R2",2), 
				new Term[]{UntypedConstant.create("c2"),UntypedConstant.create("c4")});
		...
		Atom n2 = Atom.create(Predicate.create("R2",2), 
				new Term[]{TypedConstant.create(new String("John")),TypedConstant.create(new String("John"))});
		
		Atom n3 = Atom.create(Predicate.create(QNames.EQUALITY.toString(), 2, true), 
				new Term[]{UntypedConstant.create("c3"),TypedConstant.create(new String("John"))});
		
		Atom n4 = Atom.create(Predicate.create(QNames.EQUALITY.toString(), 2, true), 
				new Term[]{UntypedConstant.create("c1"),UntypedConstant.create("c2")});
		
		Atom n5 = Atom.create(Predicate.create(QNames.EQUALITY.toString(), 2, true),
				new Term[]{UntypedConstant.create("c3"),UntypedConstant.create("c4")});
		
		Atom n6 = Atom.create(Predicate.create(QNames.EQUALITY.toString(), 2, true), 
				new Term[]{UntypedConstant.create("c2"),UntypedConstant.create("c3")});
		
		Atom n7 = Atom.create(Predicate.create(QNames.EQUALITY.toString(), 2, true),
