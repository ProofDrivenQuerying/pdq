...
public class ReasonerUtilityTest2 extends ReasonerUtilityTest0 {
	...
	public void test12() {
		...
		Assert.assertEquals(false, r15);
		Assert.assertEquals(false, r16);
