...
public class yh_geo_code extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			String s = request.getParameter("namespace");
			String t = request.getParameter("code");
			boolean canPrint = false;
			if ((s == null || s.isEmpty()) && (t == null || t.isEmpty()))
				canPrint = true;
			else if ((s == null || s.isEmpty()) && "FR".equals(t))
				canPrint = true;
			else if ((t == null || t.isEmpty()) && "iso".equals(s))
				canPrint = true;
			out.println("<yh_geo_code>");
			if (canPrint) {
				out.println("<YahooPlaceCode>");
				out.println("<namespace>" + "iso" + "</namespace>");
				out.println("<code4>" + "FR" + "</code4>");
