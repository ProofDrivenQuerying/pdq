...
public class ExplorationSetUpForJson {
    ...
    /** The log. */
    protected static Logger log = Logger.getLogger(ExplorationSetUpForJson.class);
     ...
     *
     */
    public ExplorationSetUpForJson(PlannerParameters params, CostParameters costParams, ReasoningParameters reasoningParams, DatabaseParameters databaseParams, Schema schema) {
     ...
     * @throws SQLException
     */
    public PlanTree<SearchNode> search(ConjunctiveQuery query) throws PlannerException, SQLException {
        ...
        try {
            ...
            return ((LinearExplorer)explorer).getPlanTree();
