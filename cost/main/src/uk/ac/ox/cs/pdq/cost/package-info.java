...
/**
	...
	The class SimpleCatalog implements the Catalog interface and supports SQL Server 2014 histograms and frequency maps.
	The statistics are loaded from catalog.properties files.  
