...
import uk.ac.ox.cs.pdq.plan.ToSequentialPlanTranslator;
...
public class TotalAccessCostEstimator<P extends Plan> implements BlackBoxCostEstimator<P>{
	...
	public DoubleCost estimateCost(P plan) {
		...
		SequentialPlan normalised = new ToSequentialPlanTranslator().translate((RelationalOperator) plan.getEffectiveOperator());
